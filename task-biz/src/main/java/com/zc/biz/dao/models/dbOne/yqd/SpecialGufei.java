...
@Table(name = "special_gufei")
public class SpecialGufei implements Serializable {
    @Id
    private Integer id;
     ...
     * 获取固废处理量（万吨/年）
     *
     * @return removal_efficiency - 固废处理量（万吨/年）
     */
     ...
     * 设置固废处理量（万吨/年）
     *
     * @param removalEfficiency 固废处理量（万吨/年）
     */

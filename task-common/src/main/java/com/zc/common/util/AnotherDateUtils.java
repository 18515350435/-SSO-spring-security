...
public class AnotherDateUtils {
    ...
    public static Date dateAdd(Date date, int days, boolean includeTime) throws ParseException{
        ...
        if(!includeTime){
            SimpleDateFormat sdf = new SimpleDateFormat(AnotherDateUtils.DATE_PATTERN);
    ...
    public static String dateFormat(Date date, String pattern) throws ParseException{
        if(pattern.isEmpty()){
            pattern = AnotherDateUtils.DATE_PATTERN;
        }
    ...
    public static String dateTimeToDateString(Date dateTime) throws ParseException{
        String dateTimeString = AnotherDateUtils.dateFormat(dateTime, AnotherDateUtils.DATE_TIME_PATTERN);
